...
export class BoardRecommendComponent implements OnInit {
  ...
  g_keyward = ["컴퓨터","공학", "전자","정보", "IT","시스템","산업","기계","공대","전기","안전","건축","건설"];
  y_keyward = ["인테리어","패션","시각","영상","디자인","아이디어","만화","캐릭터","예대","웹툰","그림"];
  s_keyward = ["경영","경제","무역","행정","논문","마케팅","사과대","사회"];
  I_keyward = ["한국어","문학","시나리오","영어","영문","역사","작문","독해","논문","마케팅","인문"];
  recommendMatchs = [];
  contests = [];
  matchs = [];
  resultmatchs = [];
